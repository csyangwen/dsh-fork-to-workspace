/**
 * Build the dsh-fork-to-workspace client bundle.
 *
 ...
 *
 * 复制自 dsh-memory-evolve 的 scripts/build.mjs（同款 wire 契约）。
 */
...
/**
 * Loader entry name — must equal the patch row `name` EXACTLY (自 DSH 08-06 起
 * 标准安装：`dsh plugin --profile web add <pkg>`，client bundle 注册 ID 即
 * package.json 的 name)。
 */
