...
function ImportDialog({ ctx, onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "fw-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { ref: rootRef, className: "fw-dialog", role: "dialog", "aria-modal": "true", children: [
    ...
    phase === "done" && result !== null && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "fw-dialog-success", children: t("import.success", {
...
function injectSidebarMenuItems(ctx, getRow) {
  for (const menu of document.querySelectorAll('[role="menu"]')) {
    ...
    forkItem2.innerHTML = `<span class="fw-menuitem-icon">${BRANCH_ICON_SVG}</span><span class="fw-menuitem-label">${t("menu.forkToWorkspace")}</span>`;
