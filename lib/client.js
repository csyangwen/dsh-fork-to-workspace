...
function ForkDialog({ sessionId, atSeq, ctx, onClose }) {
  ...
  const [presetChoice, setPresetChoice] = React2.useState("");
  const [presets, setPresets] = React2.useState([]);
  const [sourcePreset, setSourcePreset] = React2.useState(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "fw-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { ref: rootRef, className: "fw-dialog", role: "dialog", "aria-modal": "true", children: [
    ...
    phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      presets.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "fw-dialog-preset", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "fw-dialog-section", children: t("dialog.preset") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "", children: t("dialog.preset.keep", {
                preset: sourcePreset === null ? t("dialog.preset.keepNone") : sourcePreset
              }) }),
              presets.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                "option",
                {
                  value: preset.id,
                  disabled: preset.broken !== void 0,
                  title: preset.broken === void 0 ? void 0 : t("dialog.preset.broken", { reason: preset.broken }),
                  children: [
                    preset.name === void 0 ? preset.id : preset.name,
                    " ",
                    "(",
                    preset.id,
                    ")",
                    preset.trust === "system" ? ` \xB7 ${t("dialog.preset.system")}` : ` \xB7 ${t("dialog.preset.user")}`,
                    preset.isDefault ? ` \xB7 ${t("dialog.preset.default")}` : "",
                    preset.broken !== void 0 ? ` \xB7 ${t("dialog.preset.brokenShort")}` : ""
                  ]
                },
                preset.id
              ))
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "fw-dialog-hint", children: t("dialog.preset.hint") })
      ] }),
